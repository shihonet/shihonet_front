  ...
  <div class="mt-6">
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        <p class="text-sm text-gray-400">1998年2月2日</p>
        <hr />
        <div class="mt-2 mx-4">
          <p>3人姉妹の次女として誕生。（東京都出身）</p>
        </div>
      </div>
    </FadeInOnScroll>
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        <p class="text-sm text-gray-400">2016年5月8日</p>
        <hr />
        <div class="mt-2 mx-4">
          <p>けやき坂46 メンバーオーディションに合格。</p>
        </div>
      </div>
    </FadeInOnScroll>
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        ...
        <div class="mt-2 mx-4">
          ...
          <iframe
            src="https://www.youtube.com/embed/eQBtQTPCyV4?si=LbDCS-dOjr6Vur4A"
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        <p class="text-sm text-gray-400">2019年2月11日</p>
        <hr />
        <div class="mt-2 mx-4">
          <p>けやき坂46から日向坂46に改称。</p>
        </div>
      </div>
    </FadeInOnScroll>
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        <p class="text-sm text-gray-400">2019年3月27日</p>
        <hr />
        <div class="mt-2 mx-4">
          <p>
            デビューシングル「キュン」発売をもって、日向坂46として単独デビュー。
          </p>
        </div>
      </div>
    </FadeInOnScroll>
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        ...
        <div class="mt-2 mx-4">
          ...
          <iframe
            src="https://www.youtube.com/embed/Z59HsgPVbWY?si=pw2mKbz8lBc3EoB0"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin"
            allowfullscreen
      ...
      <div class="mx-2 mb-10">
        ...
        <div class="mt-2 mx-4">
          ...
          <p class="mt-2">
            ...
            写真集公式Xアカウントは
            <a
              href="https://x.com/katoshi_aloha"
              target="_blank"
              class="text-site-color hover:underline"
              >こちら</a
            >
          ...
          <div class="mt-2 mx-10">
            <img
              src="https://cdn.hinatazaka46.com/files/14/tsujo.jpg"
              class="mt-4"
            />
          </div>
          <div class="mt-4 flex flex-col">
            ...
            <div class="mt-4 flex space-x-4 justify-center">
              <a
                href="https://amzn.asia/d/8VKrKAb"
                target="_blank"
                class="text-blue-500"
              >
                <div
                  class="py-2 w-[160px] border border-blue-500 rounded-lg text-center hover:bg-blue-100"
                >
                  アマゾン
                </div>
              </a>
              <a
                href="https://books.rakuten.co.jp/rb/17495252/"
                target="_blank"
                class="text-blue-500"
              >
                <div
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        ...
        <hr />
        <div class="mt-2 mx-4">
          <p class="text-[14px] text-site-color font-bold">初主演ドラマ</p>
          <p class="text-[20px] text-site-color font-bold">
            「これから配信はじめます」
          </p>
          <p class="mt-2">
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        ...
        <hr />
        <div class="mt-2 mx-4">
          <p class="text-[14px] text-site-color font-bold">連続ドラマ初主演</p>
          <p class="text-[20px] text-site-color font-bold">
            「彩香ちゃんは弘子先輩に恋してる」
          </p>
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        <p class="text-sm text-gray-400">2024年7月13日</p>
        <hr />
        <div class="mt-2 mx-4">
          <p>
            【日向坂ちゃんねる】<br />
            『【お忍び】かとし×こさかなのハウステンボスデート【Vlog】』
          </p>
          <iframe
            src="https://www.youtube.com/embed/Oufuje3Kr9Y?si=dvOzKtxVrU5kS4ni"
            title="YouTube video player"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin"
            allowfullscreen
    ...
    <FadeInOnScroll>
      <div class="mx-2 mb-10">
        <p class="text-sm text-gray-400">2024年8月6日</p>
        <hr />
        <div class="mt-2 mx-4">
          <p>
            <a
